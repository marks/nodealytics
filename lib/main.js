...
exports.trackEvent = function (category, action, label, value, page_title, page_url, utmni, utmhid, callback) {  
  if (typeof label === 'function') {
    ...
    callback = value;
    value = undefined;
  } else if (typeof page_title === 'function') {
    callback = page_title;
    page_title = undefined;
  } else if (typeof page_url === 'function') {
    callback = page_url;
    page_title = undefined;
